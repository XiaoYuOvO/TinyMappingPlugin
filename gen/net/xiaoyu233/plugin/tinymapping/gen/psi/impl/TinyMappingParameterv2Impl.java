...
public class TinyMappingParameterv2Impl extends ASTWrapperPsiElement implements TinyMappingParameterv2 {

  public TinyMappingParameterv2Impl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull TinyMappingVisitor visitor) {
    visitor.visitParameterv2(this);
  }
