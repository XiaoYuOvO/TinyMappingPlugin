...
public class TinyMappingClsv1Impl extends ASTWrapperPsiElement implements TinyMappingClsv1 {

  public TinyMappingClsv1Impl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull TinyMappingVisitor visitor) {
    visitor.visitClsv1(this);
  }
