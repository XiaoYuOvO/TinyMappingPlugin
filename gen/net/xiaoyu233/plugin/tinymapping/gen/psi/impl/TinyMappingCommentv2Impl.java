...
public class TinyMappingCommentv2Impl extends ASTWrapperPsiElement implements TinyMappingCommentv2 {

  public TinyMappingCommentv2Impl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull TinyMappingVisitor visitor) {
    visitor.visitCommentv2(this);
  }
