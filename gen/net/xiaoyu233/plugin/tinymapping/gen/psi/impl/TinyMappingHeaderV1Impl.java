...
public class TinyMappingHeaderV1Impl extends ASTWrapperPsiElement implements TinyMappingHeaderV1 {

  public TinyMappingHeaderV1Impl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull TinyMappingVisitor visitor) {
    visitor.visitHeaderV1(this);
  }
