...
public class TinyMappingFieldv2Impl extends ASTWrapperPsiElement implements TinyMappingFieldv2 {

  public TinyMappingFieldv2Impl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull TinyMappingVisitor visitor) {
    visitor.visitFieldv2(this);
  }
