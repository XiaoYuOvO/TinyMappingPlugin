...
public class TinyMappingFieldv1Impl extends ASTWrapperPsiElement implements TinyMappingFieldv1 {

  public TinyMappingFieldv1Impl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull TinyMappingVisitor visitor) {
    visitor.visitFieldv1(this);
  }
