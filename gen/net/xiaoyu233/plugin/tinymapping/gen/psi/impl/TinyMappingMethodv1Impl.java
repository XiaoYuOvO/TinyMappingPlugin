...
public class TinyMappingMethodv1Impl extends ASTWrapperPsiElement implements TinyMappingMethodv1 {

  public TinyMappingMethodv1Impl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull TinyMappingVisitor visitor) {
    visitor.visitMethodv1(this);
  }
